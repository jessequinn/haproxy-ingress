...
func createDefaults() map[string]string {
	return map[string]string{
		...
		types.GlobalCorazaTimeoutConnect:         "5s",
		types.GlobalCorazaTimeoutClient:          "5s",
		types.GlobalCorazaTimeoutHello:           "100ms",
		types.GlobalCorazaTimeoutIdle:            "30s",
		types.GlobalCorazaTimeoutProcessing:      "1s",
		types.GlobalCorazaTimeoutServer:          "5s",

...
const (
	...
	GlobalCorazaEndpoints              = "coraza-endpoints"
	GlobalCorazaTimeoutConnect         = "coraza-timeout-connect"
	GlobalCorazaTimeoutClient          = "coraza-timeout-client"
	GlobalCorazaTimeoutHello           = "coraza-timeout-hello"
	GlobalCorazaTimeoutIdle            = "coraza-timeout-idle"
	GlobalCorazaTimeoutProcessing      = "coraza-timeout-processing"
	GlobalCorazaTimeoutServer          = "coraza-timeout-server"
